...
?>
<p><a href="/" class="link-dark">Головна</a><span>>></span><a href="/clothing" class="link-dark">Одяг</a></p>
<? if($_SESSION['user']['login'] == 'admin') :?>
    <a href="/clothing/add" class="btn btn-outline-success" >Додати товар</a>
...
<? if(!empty($lastClothing)) :?>
    ...
    <div class="row text-center">
        <?php foreach ($lastClothing as $clothing) :?>
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <div class="tovar-block">
                    ...
                    <div class="photo">
                        <? if (is_file('files/clothing/'.$clothing['photo'].'_s.jpg')) : ?>
                            <img class="bd-placeholder-img rounded " src="/files/clothing/<?=$clothing['photo']?>_s.jpg">
                        <? else: ?>
                    ...
                    <div>
                        <h3><b><?=$clothing['price']?> грн.</b></h3>
                    </div>
                    <div>
                        <a href="/clothing/view?id=<?=$clothing['id']?>" class="btn btn-primary">Дізнатися більше</a>
                        <? if($_SESSION['user']['login'] == 'admin'):?>
                            <br/>
                            <a href="/clothing/edit?id=<?=$clothing['id']?>" class="btn btn-success mt-2">Редагувати</a>
                            <a href="/clothing/delete?id=<?=$clothing['id']?>" class="btn btn-danger mt-2">Видалити</a>
                        <? endif;?>
                    </div>
                </div>
            </div>
