...
?>
<p><a href="/" class="link-dark">Головна</a><span>>></span><a href="/accessories" class="link-dark">Аксесуари</a></p>
<? if($_SESSION['user']['login'] == 'admin') :?>
    <a href="/accessories/add" class="btn btn-outline-success" >Додати товар</a>
...
<? if(!empty($lastAccessories)) :?>
    ...
    <div class="row text-center">
        <?php foreach ($lastAccessories as $accessory) :?>
            <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12">
                <div class="tovar-block">
                    ...
                    <div class="photo">
                        <? if (is_file('files/accessories/'.$accessory['photo'].'_s.jpg')) : ?>
                            <img class="bd-placeholder-img rounded " src="/files/accessories/<?=$accessory['photo']?>_s.jpg">
                        <? else: ?>
                    ...
                    <div>
                        <h3><b><?=$accessory['price']?> грн.</b></h3>
                    </div>
                    <div>
                        <a href="/accessories/view?id=<?=$accessory['id']?>" class="btn btn-primary">Дізнатися більше</a>
                        <? if($_SESSION['user']['login'] == 'admin'):?>
                            <br/>
                            <a href="/accessories/edit?id=<?=$accessory['id']?>" class="btn btn-success mt-2">Редагувати</a>
                            <a href="/accessories/delete?id=<?=$accessory['id']?>" class="btn btn-danger mt-2">Видалити</a>
                        <? endif;?>
                    </div>
                </div>
            </div>
