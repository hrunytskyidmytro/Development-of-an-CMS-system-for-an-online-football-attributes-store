...
/**
 * Контролер для модуля ResponseForFootballShoes
 */
class ResponseForFootballShoes extends Controller
{
    protected $user;
    protected $responseFSModel;
    protected $userModel;
    public function __construct()
    {
        $this->userModel = new \models\Users();
        $this->responseFSModel = new \models\ResponseForFootballShoes();
    ...
    public function actionIndex()
    {
        ...
        $lastResponse = $this->responseFSModel->GetLastResponses($Config['ResponseCount']);
    ...
    {
        $id = $_GET['id'];
        $response = $this->responseFSModel->GetResponsesById($id);
    ...
    public function actionAdd()
    {
        ...
        if($this->isPost())
        {
            $result = $this->responseFSModel->AddResponse($_POST);
    ...
    public function actionEdit()
    {
        ...
        if($this->isPost())
        {
            $result = $this->responseFSModel->UpdateResponse($_POST,$id);
            if($result === true) {
    ...
    public function actionDelete()
    {
        ...
        {
            $result = $this->responseFSModel->DeleteResponse($id);
            if($result == true)
