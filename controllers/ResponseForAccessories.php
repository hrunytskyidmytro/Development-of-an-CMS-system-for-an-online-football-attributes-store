...
/**
 * Контролер для модуля ResponseForAccessories
 */
class ResponseForAccessories extends Controller
{
    protected $user;
    protected $responseAccessoriesModel;
    protected $userModel;
    public function __construct()
    {
        $this->userModel = new \models\Users();
        $this->responseAccessoriesModel = new \models\ResponseForAccessories();
    ...
    {
        global $Config;
        $title = 'Відгуки про аксесуари - FootballFan.Shop - футбольний магазин';
        $lastResponse = $this->responseAccessoriesModel->GetLastResponses($Config['ResponseCount']);
    ...
    {
        $id = $_GET['id'];
        $response = $this->responseAccessoriesModel->GetResponsesById($id);
    ...
    public function actionAdd()
    {
        ...
        if($this->isPost())
        {
            $result = $this->responseAccessoriesModel->AddResponse($_POST);
    ...
    public function actionEdit()
    {
        ...
        if($this->isPost())
        {
            $result = $this->responseAccessoriesModel->UpdateResponse($_POST,$id);
            if($result === true) {
    ...
    public function actionDelete()
    {
        ...
        {
            $result = $this->responseAccessoriesModel->DeleteResponse($id);
            if($result == true)
